ThreeTwoClarinet = \relative d'' {
    ...
    d8 ) -! r8 e8 -! r8 | % 8
    fis8 -! r8 g8 -! r8 | % 9
    a8. ( g16 fis8 ) e8 -! | \barNumberCheck #10
    d8 -! fis8 -! d8 -! r8 | % 11
    e4. ( fis8 ) | % 12
    g8 fis8 e8 fis8 | % 13
    g8 fis8 e4 | % 14
    ...
    g8 -. es8 ( d8 ) c8 -. | % 48
    bes8 r8 d4 | % 49
    d8 ( es16. ) d32 -. c8 -. d8 -. | \barNumberCheck #50
    es8 r8 es4 | % 51
    es8 ( f16. ) es32 -! d8 es8 | % 52
    f4 ( g8 ) f8 -! | % 53
    es4 ( fis8 ) es8 -! | % 54
    d4 d8 d8 | % 55
    d8 ( f8 e8 d8 ) | % 56
