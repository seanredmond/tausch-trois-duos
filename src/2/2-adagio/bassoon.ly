TwoTwoBassoon = \relative f {
    \repeat volta 2 {
        ...
        c16 b16 b8
          ...
          e32 [ d32 c32 b32 ] }
        \alternative {
          { d4 c16 cis16 e16 d16 cis16 bes!16 a16 g16 }
    ...
    b16 -. [ b32 ( f'32 ) ]
      ...
      e32 \> [ ( f32 ) f32 ( e32 ) ]
      e32 [ ( d32 ) c32 ( b32 ) ] | % 34
    a8 -. \p \< f16 ( g16 ) a16 -. f16 -. g16 -. a16 -. bes8 b8 | % 35
    d16 \> ( c16 bes16 ) a16 -.
      gis16 \< ( a16 ) bes16 -. a16 -.
      a16 \> ( g16 ) f16 -. e16 -. | % 36
    f8 -. \p c'8 ( a8 f8 e8 c8 ) | % 37
